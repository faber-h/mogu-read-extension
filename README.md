...
단순한 정보 조회를 넘어, 실제 위치에 **인디케이터**(표시자)를 삽입하고 해당 지점으로 부드럽게 스크롤하여 정확한 위치를 안내합니다.

### 작동 흐름
<img width="647" height="1000" alt="제거 위치 표시 flow" src="https://github.com/user-attachments/assets/3d406d30-8034-4de2-acde-aa8c3ad61823" />
